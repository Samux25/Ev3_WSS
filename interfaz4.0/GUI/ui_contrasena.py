# Form implementation generated from reading ui file 'contraseña.ui'
#
...
"color:rgb(247, 247, 247);")
        ...
        self.label_6.setPixmap(QtGui.QPixmap("img/logo.png"))
...
"")
        ...
        self.contraAntigua = QtWidgets.QLineEdit(parent=self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.contraAntigua.setFont(font)
        self.contraAntigua.setStyleSheet("QLineEdit {\n"
"border: 2px solid rgb(148,148,148);\n"
"border-radius: 3px;\n"
"}\n"
"")
        self.contraAntigua.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.contraAntigua.setObjectName("contraAntigua")
        self.verticalLayout_3.addWidget(self.contraAntigua)
        self.mostrarContra_2 = QtWidgets.QCheckBox(parent=self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.mostrarContra_2.setFont(font)
        self.mostrarContra_2.setObjectName("mostrarContra_2")
        self.verticalLayout_3.addWidget(self.mostrarContra_2)
        spacerItem5 = QtWidgets.QSpacerItem(20, 3, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.nuevaContra = QtWidgets.QLineEdit(parent=self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.nuevaContra.setFont(font)
        self.nuevaContra.setStyleSheet("QLineEdit {\n"
"border: 2px solid rgb(148,148,148);\n"
"border-radius: 3px;\n"
"}\n"
"")
        self.nuevaContra.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.nuevaContra.setObjectName("nuevaContra")
        self.verticalLayout_3.addWidget(self.nuevaContra)
        self.mostrarContra = QtWidgets.QCheckBox(parent=self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.mostrarContra.setFont(font)
        self.mostrarContra.setObjectName("mostrarContra")
        self.verticalLayout_3.addWidget(self.mostrarContra)
        ...
        self.ConfirmarCambioContra = QtWidgets.QPushButton(parent=self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.ConfirmarCambioContra.setFont(font)
        self.ConfirmarCambioContra.setStyleSheet("QPushButton {\n"
"border-radius: 8px;\n"
"border: 2px solid rgb(148,148,148);\n"
"background-color: rgb(85, 170, 255);\n"
"color: rgb(255, 255, 255);\n"
"}")
        self.ConfirmarCambioContra.setObjectName("ConfirmarCambioContra")
        self.verticalLayout_3.addWidget(self.ConfirmarCambioContra)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Cambio de contraseña"))
        self.label_2.setText(_translate("MainWindow", "Cambiar contraseña"))
        self.label_3.setText(_translate("MainWindow", "Rut:"))
        self.label_4.setText(_translate("MainWindow", "Ingrese su contraseña:"))
        self.mostrarContra_2.setText(_translate("MainWindow", "Monstrar contraseña"))
        self.label_7.setText(_translate("MainWindow", "Ingrese su nueva contraseña:"))
        self.mostrarContra.setText(_translate("MainWindow", "Monstrar contraseña"))
        self.ConfirmarCambioContra.setText(_translate("MainWindow", "Confirmar Cambio de contraseña"))
